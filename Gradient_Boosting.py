...
def train_and_evaluate(X_train, y_train, X_test, y_test, plot_name):
    ...
    with mlflow.start_run(run_name="GradientBoosting_Model") as run:
        model_name = f"GradientBoosting_{plot_name}"
        mlflow.set_tags({
            "model_name": model_name,
            "experiment_type": "GradientBoosting",
            "description": "Predicting Readmission with Gradient Boosting"
        })
